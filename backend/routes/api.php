...
use App\Http\Controllers\Api\BloqueiosAtivosPdfController;
...
use App\Http\Controllers\Api\EcrvPdfController;
...
use App\Http\Controllers\Api\PlacasZeroKmConsultaController;
use App\Http\Controllers\Api\PublicPlacasZeroKmQueueController;
...
Route::post('bin/pdf', BinPdfController::class);
Route::get('bin', BinController::class);
Route::get('bloqueios-ativos', BloqueiosAtivosController::class);
Route::post('bloqueios/pdf', BloqueiosAtivosPdfController::class);
Route::get('gravame', GravamePesquisaController::class);
Route::post('gravame/pdf', GravamePdfController::class);
...
Route::post('ecrv/pdf', EcrvPdfController::class);
...
Route::post('public/placas-0km/consultar', PlacasZeroKmConsultaController::class)->middleware('throttle:30,1');
...
Route::post('public/placas-0km/runner/reset', [PublicPlacasZeroKmQueueController::class, 'resetRunnerState'])->middleware('throttle:10,1');
