...
@php
    ...
    $placa = $formatValue($veiculo['placa'] ?? null);
    $renavam = $formatValue($veiculo['renavam'] ?? null);
...
@endphp
    ...
    <div class="report-title">
        <h2>PESQUISA BASE ESTADUAL</h2>
        <p>Data da pesquisa: {{ $generatedAt }}</p>
    </div>

    <p class="meta-line">Placa: {{ $placa }} &nbsp; | &nbsp; Renavam: {{ $renavam }}</p>
