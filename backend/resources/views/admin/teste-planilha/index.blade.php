...
@section('content')
    ...
    <header class="teste-planilha__header">
        ...
        <p>Faça upload de uma planilha XLSX com placas/renavams para verificar se as transferências foram concluídas.</p>
    </header>
    ...
    <div class="teste-planilha__card" id="verificationCard" style="display: none;">
        <h2>2. Nome para Verificação</h2>

        <div class="teste-planilha__form-row">
            <div class="teste-planilha__form-group" style="max-width: 500px;">
                <label for="nomeVerificacao">Nome do vendedor/proprietário anterior</label>
                <input
                    type="text"
                    id="nomeVerificacao"
                    class="teste-planilha__input"
        ...
        <p style="margin-top: 12px; font-size: 13px; color: var(--text-muted);">
            Se o nome do proprietário atual for igual a este nome, significa que a <strong>transferência NÃO foi concluída</strong>.
        </p>
    ...
    <div class="teste-planilha__card" id="resultsCard" style="display: none;">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
            ...
            <button type="button" class="teste-planilha__btn teste-planilha__btn--success" id="btnDownload" disabled>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    ...
    <script>
        (function() {
            ...
            btnIniciar.addEventListener('click', async () => {
                ...
                const nome = nomeVerificacao.value.trim();
                if (!nome) {
                    alert('Por favor, informe o nome para verificação.');
                    return;
                }
            ...
            btnLimpar.addEventListener('click', () => {
                if (isProcessing) {
                    if (!confirm('Uma verificação está em andamento. Deseja realmente limpar?')) {
                        return;
                    }
                }
            ...
            btnDownload.addEventListener('click', async () => {
                ...
                try {
                    ...
                    a.href = url;
                    a.download = 'resultado_verificacao_' + new Date().toISOString().slice(0, 10) + '.xlsx';
