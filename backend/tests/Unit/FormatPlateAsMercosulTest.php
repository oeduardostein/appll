...
class FormatPlateAsMercosulTest extends TestCase
{
    ...
    {
        $this->assertSame('ABC1134', format_plate_as_mercosul('ABC-1134'));
        $this->assertSame('XYZ4689', format_plate_as_mercosul('xyz-4689'));
    }
    ...
    {
        $this->assertSame('ABC1134', format_plate_as_mercosul('a b c 1 1 3 4'));
    }
