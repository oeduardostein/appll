...
import '../base_state/multas_outros_estados_page.dart';
import 'bin_gravame_page.dart';
import 'bin_restricoes_page.dart';
import 'bin_vehicle_info_page.dart';

class BinResultPage extends StatelessWidget {
  const BinResultPage({super.key});
...
class _BinOptionList extends StatelessWidget {
  const _BinOptionList();
    ...
    return Column(
      children: const [
        _BinOption(
          ...
          destinationBuilder: BinVehicleInfoPage.new,
        ),
        SizedBox(height: 12),
        _BinOption(
          icon: Icons.assignment_outlined,
          label: 'Gravame',
          destinationBuilder: BinGravamePage.new,
        ),
        SizedBox(height: 12),
        _BinOption(
          icon: Icons.lock_outline,
          label: 'Restrições',
          destinationBuilder: BinRestricoesPage.new,
          highlighted: true,
        ),
        SizedBox(height: 12),
        _BinOption(
